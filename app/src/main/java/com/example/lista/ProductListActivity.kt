...
class ProductListActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        loadProductList()
        val i = Intent(this@ProductListActivity, Modify::class.java)
        i.putExtra("productlist", ProductListActivity::class.java.toString())
        //LayoutManager
        ...
        if (user != null) {
            firestoreListener = db!!.collection(user.uid)
                .addSnapshotListener(EventListener { documentSnapshots, e ->
                    ...
                    mAdapter = MyAdapter(notesList, applicationContext, db!!)
            ...
            db!!.collection(user.uid)
                ...
                .addOnCompleteListener { task ->
                    if (task.isSuccessful) {
                        ...
                        mAdapter = MyAdapter(productList, applicationContext, db!!)
